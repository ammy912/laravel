              ...
              <table class="table" id="tab1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href='{{URL("/admin-login/managecustomer/".$row->id)}}' class="btn btn-sm btn-danger" onclick="return confirm('Are you sure to delete data')"><i class="bi bi-trash3-fill"></i></a> |
